...
Решить задание по установке политики синхранизации очередей только с помощью перехода на версию rabbitmq 3.13.7
Даже те варианты которые вы написали не работают на версии RabbitMQ version: 4.2.1
...
[playbook.yml](https://github.com/ilaryhlik17854-stack/HW_DATABASES/blob/main/4-The_RabbitMQ_queue/img/playbook.yml)